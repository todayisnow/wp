...
class DWQA_Leaderboard_Widget extends WP_Widget {
	public function __construct() {
		...
		parent::__construct( 'dwqa_leaderboard', __( 'DWQA Leaderboard', 'dwqa-leaderboard' ), $widget_ops );

		add_action( 'wp_enqueue_scripts', array( $this, 'enqueue_script' ) );
	}

	public function widget( $args, $instance ) {
		$title = isset( $instance['title'] ) ? $instance['title'] : __( 'Leaderboard', 'dwqa-leaderboard' );
				...
				<li>
					<div class="dwqa-user-block">
						...
						<div class="dwqa-user-content">
							...
							<span class="quesiton-count"><?php echo $this->count_question( $user['user_id'], $time ) ?> <?php _e( 'questions', 'dwqa-leaderboard' ) ?></span>
							<span class="answer-count"><?php echo $user['answer'] ?> <?php _e( 'answers', 'dwqa-leaderboard' ) ?></span>
						</div>
					</div>
				</li>
				<?php $i++; ?>
	...
	public function form( $instance ) {
		...
		<p>
			<label>
				<?php _e( 'Number of top users/members', 'dwqa-leaderboard' ); ?>
		...
		<p>
			<label>
				<?php _e( 'Time', 'dwqa-leaderboard' ); ?>
				<select id="<?php echo $this->get_field_id( 'time' ) ?>" name="<?php echo $this->get_field_name( 'time' ) ?>">
					<option <?php selected( $time, 'all_the_time' ) ?> value="all_the_time"><?php _e( 'All the time', 'dwqa-leaderboard' ); ?></option>
					<option <?php selected( $time, 'this_month' ); ?> value="this_month"><?php _e( 'This month', 'dwqa-leaderboard' ); ?></option>
					<option <?php selected( $time, 'last_month' ); ?> value="last_month"><?php _e( 'Last month', 'dwqa-leaderboard' ); ?></option>
					<option <?php selected( $time, 'this_week' ); ?> value="this_week"><?php _e( 'This week', 'dwqa-leaderboard' ); ?></option>
					<option <?php selected( $time, 'last_week' ); ?> value="last_week"><?php _e( 'Last week', 'dwqa-leaderboard' ); ?></option>
				</select>
			</label>
		</p>
		<?php
