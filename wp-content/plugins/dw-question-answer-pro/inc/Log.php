...
class DWQA_Log {
	...
	public function auto_clear_question_log( $parent_id = 0 ) {
		$question_id = absint( $parent_id );
		if ( 'dwqa-answer' == get_post_type( $parent_id ) ) {
			$question_id = get_post_meta( $parent_id, '_question', true );
		}
